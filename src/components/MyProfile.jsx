        ...
        <div className="max-w-screen-xl flex items-center h-auto lg:h-screen justify-between mx-auto my-32 lg:my-0">
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <p className="pt-2 text-xs lg:text-lg flex items-center justify-start lg:ml-0 ml-12 lg:justify-start">
              ...
              <div className="block lg:hidden">
                <p className="pt-4 text-base font-bold flex items-center ml-12 lg:ml-0  justify-start lg:justify-start">
                  <IoMdMail className="mr-2 font-bold text-xl  text-blue-800" />
                  {user?.email}
                </p>
              </div>
              <p className="pt-4 text-base font-bold flex items-center justify-start lg:ml-0 ml-12">
                <IoMdCall className="mr-2 text-start font-bold text-xl text-blue-800" />
                {logUser?.number}
              </p>

              <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                <FaSlackHash className="mr-2 font-bold -ml-12 lg:ml-0 text-xl text-blue-800" />
                {user?.uid}
              </p>
            </div>
          </div>
